...
# --- 6. ПАССАЖИР (Твои настройки: Универсальное тело + Разножка + Масштаб) ---
# Часть 1: Вступление
PASSENGER_START = "RIDER: A cute 3D plastic toy character of "

# Часть 2: Описание тела (Универсальное)
PASSENGER_BODY = ". BODY SHAPE: Universal simplified round vinyl toy shape. Chubby, anthropomorphic, minimalistic. PROPORTIONS: Short legs, round tummy, large simplified head. FACE: Minimalist. Eyes are simple small BLACK DOTS (pimpules). No complex fur details. "

# Часть 3: Поза и Масштаб (Исправлено: Разножка и Плечи выше руля)
PASSENGER_PHYSICS = "SCALE: The character is large. SHOULDERS MUST BE HIGHER than the scooter handlebars. ARMS: Arms extended, HANDS FIRMLY GRIPPING THE T-HANDLEBARS. LEGS: ONE LEG PLACED SLIGHTLY AHEAD OF THE OTHER. FEET: SOLES OF FEET FLAT ON THE DECK SURFACE. ZERO GAP. POSE: Weight bearing standing pose. Grounded. NOT levitating."
